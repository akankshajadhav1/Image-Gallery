...
const Search2 = () => {
  ...
  console.log(serach);
  return (
    <div className=" mb-3 flex flex-col md:flex-row items-center w-full md:w-4/6 lg:w-2/3 h-20 justify-between bg-opacity-12 backdrop-filter backdrop-blur-md p-2 rounded-md shadow-inner-md border border-white shadow-md ml-2 md:ml-10 mt-1 md:mt-0">
